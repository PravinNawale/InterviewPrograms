...
class UniqueImages {
    public static class Image {
        ...
        public boolean equals(Object other) {
            ...
            /*
             * Making the file name case sensitive
             */
        ...
        /*
         * HashCode equals contract has to be followed and hashcode should be same if the height and width is same
         */
        @Override
        public int hashCode() {
        	int prime = 31;
        	int result = 1;
        	result = result + prime * width * height;
        	return result;
        }
