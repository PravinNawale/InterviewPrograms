...
public class DistributedLRUCache {
	...
	public static void main(String[] args) {
		LRUCacheOld lrucache = new LRUCacheOld();
...
class LRUCacheOld {
	...
	ConcurrentHashMap<Integer, Entry> hashmap;
	Entry start, end;
	int LRU_CACHE_SIZE = 4; // Here i am setting 4 to test the LRU cache implementation, it can make be dynamic
	
	public LRUCacheOld() {
		hashmap = new ConcurrentHashMap<Integer, Entry>();
	}
